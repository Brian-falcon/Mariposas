...
type Round = { emoji: string; options: string[]; correct: string };

export function IdentifyEmotion({ activity }: { activity: Activity }) {
  ...
  if (result !== null) {
    ...
    return (
      <ActivityFeedback
        correct={result}
        correctMessage="¡Muy bien! Conoces las emociones 💚"
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-center mb-8">
        <span className="text-8xl" role="img" aria-label="Emoción">{round.emoji}</span>
      </div>
