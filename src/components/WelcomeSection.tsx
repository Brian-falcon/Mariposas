...
export function WelcomeSection() {
  ...
  return (
    <section className="text-center mb-8 sm:mb-12" aria-labelledby="welcome-heading">
      ...
      >
        {name ? `¡Hola, ${name}! 🦋` : "¡Bienvenido a Mariposas! 🦋"}
      </h1>
      ...
      {progress && progress.total > 0 && (
        <div
          className="inline-flex flex-col sm:flex-row items-center gap-4 sm:gap-6 p-4 sm:p-6 bg-white rounded-2xl shadow-lg border-2 border-primary-100 mb-6"
          role="status"
          aria-live="polite"
        >
