...
const DEFAULT_SOUND_URLS: Record<string, string> = {
  ...
  cerdo: "https://upload.wikimedia.org/wikipedia/commons/a/ac/Pig_grunt_-_Erdie.ogg",
  gallo: "https://upload.wikimedia.org/wikipedia/commons/8/8b/Rooster_crowing_small.ogv",
  puerta: "https://upload.wikimedia.org/wikipedia/commons/1/1c/Knocking_on_wood_or_door.ogg",
  olas: "https://upload.wikimedia.org/wikipedia/commons/1/1f/Waves.ogg",
  cigarra: "https://upload.wikimedia.org/wikipedia/commons/f/f4/Cicadas_in_Greece.ogg",
  aplausos: "https://upload.wikimedia.org/wikipedia/commons/5/5b/Applause_i.ogg",
